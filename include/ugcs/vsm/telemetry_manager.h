...
#include <ugcs/vsm/telemetry_interface.h>
#include <ugcs/vsm/telemetry_params.h>
#include <mutex>
...
public:
    ...
    public:
        ...
        /** Set telemetry parameter in the report. See ugcs::vsm::telemetry namespace
    ...
    /** Immediately send updated system status to UCS. */
    void
    Sys_status_update();
