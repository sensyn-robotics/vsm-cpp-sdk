...
public:
    ...
    enum class Type {
        /** Move action vsm::Move_action. */
        MOVE,
        /** Wait action vsm::Wait_action. */
        WAIT,
        /** Payload steering action vsm::Payload_steering_action. */
        PAYLOAD_STEERING,
        /** Takeoff action vsm::Takeoff_action. */
        TAKEOFF,
        /** Landing action vsm::Landing_action. */
        LANDING,
        /** Change speed action vsm::Change_speed_action. */
        CHANGE_SPEED,
        /** Set home action vsm::Set_home_action. */
        SET_HOME,
        /** Point of interest vsm::Poi_action. */
        POI,
        /** Heading vsm::Heading_action. */
        HEADING,
        /** Camera control action vsm::Camera_control_action. */
        CAMERA_CONTROL,
        /** Camera trigger action vsm::Camera_trigger_action. */
        CAMERA_TRIGGER,
        /** Panorama action vsm::Panorama_action. */
        PANORAMA,
        /** Task attributes action vsm::Task_attributes_action. */
        TASK_ATTRIBUTES,
    };
