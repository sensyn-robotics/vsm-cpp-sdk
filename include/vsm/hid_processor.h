...
class Hid_processor: public vsm::File_processor {
...
public:
    ...
    public:
        ...
        public:
            ...
            /** Native handle value envelope. */
            typedef File_processor::Stream::Native_handle::Envelope Envelope;
            ...
            /** Get device read handle. */
            virtual std::unique_ptr<Envelope>
            Get_read_handle() = 0;

            /** Get device write handle. */
            virtual std::unique_ptr<Envelope>
            Get_write_handle() = 0;
