...
#define _LOG_WRITE_MSG(level, msg, ...) \
    vsm::Log::Write_message(level, "[%s:%d] " msg, \
                            vsm::Log::Get_basename(__FILE__).c_str(), \
                            __LINE__, ## __VA_ARGS__)

/** Write debug message to the application log. */
#define LOG_DEBUG(msg, ...) \
    _LOG_WRITE_MSG(vsm::Log::Level::DEBUGGING, msg, ## __VA_ARGS__)
...
#define LOG_INFO(msg, ...) \
    _LOG_WRITE_MSG(vsm::Log::Level::INFO, msg, ## __VA_ARGS__)

/** Write warning message to the application log. */
#define LOG_WARNING(msg, ...) \
    _LOG_WRITE_MSG(vsm::Log::Level::WARNING, msg, ## __VA_ARGS__)
...
#define LOG_ERROR(msg, ...) \
    _LOG_WRITE_MSG(vsm::Log::Level::ERROR, msg, ## __VA_ARGS__)
