...
public:
    ...
    private:
        ...
        std::atomic_bool completion_processed,
...
private:
    ...
    std::atomic_bool disable_ongoing;
     ...
     * state in this phase.
     */
    std::atomic_bool abort_ongoing;

    /** Reference counter, if the context is managed by reference guard. */
