...
public:
    ...
    public:
        ...
        /** Default prototype for read operation completion handler. */
        typedef Callback_proxy<void, Io_result> Write_to_handler;
    ...
    private:
        ...
        /** Used for connection based protocols (tcp) */
        ...
        void
        Set_socket(platform::Socket_handle s);
    ...
    {
        return Connect(Socket_address::Create(host, service), completion_handler, completion_context);
    }
    ...
    Listen(
            ...
            Request_completion_context::Ptr completion_context = Request_temp_completion_context::Create())
    {
        return Listen(Socket_address::Create(host, service), completion_handler, completion_context, SOCK_STREAM);
    }
