...
include("${VSM_SDK_DIR}/make/common.cmake")

enable_testing()

include("${VSM_SDK_DIR}/make/unittestpp.cmake")

set(CTEST_OUTPUT_ON_FAILURE ON)

# Use Valgrind if available on build platform
...
file(GLOB FILES "${VSM_SDK_DIR}/src/include/vsm/*.h")
set(SDK_SRCS ${SDK_SRCS} ${FILES})
Find_platform_sources("${VSM_SDK_DIR}/src/platform" PLATFORM_SOURCES)
set(SDK_SRCS ${SDK_SRCS} ${PLATFORM_SOURCES})
